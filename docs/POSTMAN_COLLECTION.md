...
- You can downalod this using the this [link](https://raw.githubusercontent.com/antleaf/coar-notify-inbox-rails-engine/main/docs/coar_notify_inbox_postman_collection.json)
